...
const Knight = ({ color, size }: PieceProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
    ...
    >
      ...
      />
      <path
        fill={color === 'w' ? '#000' : '#ececec'}
        stroke={color === 'w' ? undefined : '#ececec'}
        d={
          color === 'w'
            ? 'M9.5 25.5a.5.5 0 1 1-1 0 .5.5 0 1 1 1 0zm5.433-9.75a.5 1.5 30 1 1-.866-.5.5 1.5 30 1 1 .866.5z'
            : 'M9.5 25.5a.5.5 0 1 1-1 0 .5.5 0 1 1 1 0zm5.43-9.75a.5 1.5 30 1 1-.86-.5.5 1.5 30 1 1 .86.5z'
        }
      />
      {color === 'b' && (
        <path
...
const King = ({ color, size }: PieceProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={size} height={size}>
    <g
      ...
      strokeWidth="1.5"
    >
      <path strokeLinejoin="miter" d={color === 'w' ? 'M22.5 11.63V6M20 8h5' : 'M22.5 11.6V6'} />
      <path
        fill={color === 'w' ? '#fff' : '#000'}
        strokeLinecap="butt"
        strokeLinejoin="miter"
      ...
      />
      <path fill="none" d={color === 'b' ? 'M20 8h5' : undefined} />
      {color === 'b' && (
        <path
          stroke="#ececec"
      ...
      <path
        stroke={color === 'b' ? '#ececec' : undefined}
